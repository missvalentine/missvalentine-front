...
import { Icon, Button, Row, Col, Divider, Checkbox, Modal, message } from "antd";
const Firstmodel = dynamic(() => import("./Firstmodel"));
const Secondmodal = dynamic(() => import("./SecondModal"));

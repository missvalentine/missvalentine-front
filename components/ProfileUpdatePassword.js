          ...
          this.props.userDetailsRes.userid.password ? (
            <div className="inside-form Larger ">
              <form onSubmit={this.submitRegistration}>
                ...
                <div className="row" style={{ justifyContent: "center" }}>
                  <button
                    type="submit"
                    className="mt-5 btn or-btn  btn-icon c-btn c-btn--dark "
                  >
                    Update
                  </button>
                </div>
            ...
            <div className="inside-form Larger ">
              <form onSubmit={this.submitRegistration2}>
                <div className="row frm-details change-password-container">
                ...
                <div className="" style={{ display: "flex" }}>
                  <button type="submit" className="c-btn c-btn--dark c-btn-cp">
                    Update
                  </button>
                </div>
              </form>

...
class Success extends Component {
  ...
  render() {
    ...
    const time = moment(this.props.currentAppointment.bookedFor).format(
      "MMM DD, hh:mm:a"
    );
    return (
      <div className="c-confirmation">
        <div className="container-fluid">
          <div className="consult-success-wrapper">
            ...
            {!isConfirmed && (
              <p className="c-confirmation__center">
                Your Appointment with{" "}
                <b>{this.props.currentAppointment.doctorName}</b>, scheduled for{" "}
                <b>{time}</b> is waiting for a confirmation.
              </p>
            )}
            {!isConfirmed && (
              <p className="c-confirmation__center">
            ...
            {!isConfirmed && (
              <>
                ...
                <div className="c-personalDetails__btn-wrap">
                  <Button className="c-btn c-btn--dark" onClick={this.back}>
                    Back
                  </Button>
                  <Button
            ...
            {isConfirmed && (
              <div className="c-personalDetails__btn-wrap justify-content-around">
                <Button className="c-btn c-btn--dark" onClick={this.goToShop}>
                  Continue Shopping
                </Button>
              </div>
            )}

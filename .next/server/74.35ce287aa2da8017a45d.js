...
/* harmony import */ var _redux_actions_cart__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("UrdJ");
/* harmony import */ var _services_helpers_product__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("OWVN");
...
/* harmony import */ var _redux_actions_drawers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("JLUA");
/* harmony import */ var _Product__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("nQYz");
...
const CategoryProducts = (props, {
  ...
  const addToCartFn = product => {
    if (product) {
      addToCart(Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_8__[/* directAddToCart */ "b"])(product));
      showCartBar();
    }
  };
  ...
  }, console.log('poooo', products.categories, activeCategoryIndex), activeCategoryIndex === -1 ? products.products.filter(product => product.hidden === false).map((item, index) => __jsx(_Product__WEBPACK_IMPORTED_MODULE_11__["default"], _extends({}, props, {
    key: index,
    data: item
  }))) : products.categories[activeCategoryIndex].products.filter(product => product.hidden === false).map((item, index) => __jsx(_Product__WEBPACK_IMPORTED_MODULE_11__["default"], _extends({}, props, {
    key: index,
    data: item
  }))))), __jsx("div", {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_3__["connect"])(null, {
  addToCart: _redux_actions_cart__WEBPACK_IMPORTED_MODULE_7__[/* addToCart */ "a"],
  showCartBar: _redux_actions_drawers__WEBPACK_IMPORTED_MODULE_10__[/* showCartBar */ "c"]
})(CategoryProducts));

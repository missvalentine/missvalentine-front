...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"0":"1484d4b3a1c58fd8e9d3","2":"736573eff89b7ea1e104","3":"67b473aabb397619f378","5":"5df0a4d20c8524583cb2","7":"36d63fde43cb67412583","33":"9ba921f6916541430b7b","34":"f38b7c78f99e8d6d0641","35":"012f03cddb1a655a0804","36":"0e05c12bba6a69aee836","43":"3b1dbf6faaa6b8f532bd","47":"e7b666758aa115e9130e","49":"057c1be8fb3946f0c960","50":"473ed9b281ae39c7ccb1"}[chunkId] + ".js");
...
module.exports = __webpack_require__("O25P");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ECatalogue; });
...
/* harmony import */ var _components_styles_pages_catalogue_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("PoZO");
/* harmony import */ var _components_styles_pages_catalogue_scss__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_styles_pages_catalogue_scss__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _services_apis_contact__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("4E/y");
/* harmony import */ var _services_apis_admin__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("tWEw");
...
/* harmony import */ var _components_Product_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("nQYz");
...
const Layout = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, "Vw5z")), {
  ssr: false,
  loadableGenerated: {
...
function ECatalogue() {
  ...
  const products = Object(react_redux__WEBPACK_IMPORTED_MODULE_5__["useSelector"])(state => state.products);
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_4__[/* getCategories */ "a"])());
  }, []);

  const handleLoadProducts = () => {
    if (value.subCategory._id) {
      Object(_services_apis_admin__WEBPACK_IMPORTED_MODULE_8__[/* getSubcategory */ "j"])(value.subCategory._id).then(res => {
  ...
  const handleSendEnquiry = () => {
    ...
    Object(_services_apis_contact__WEBPACK_IMPORTED_MODULE_7__[/* createContactUs */ "a"])(contactData).then(res => res.data && antd__WEBPACK_IMPORTED_MODULE_6__["Modal"].success({
    ...
    })).catch(err => antd__WEBPACK_IMPORTED_MODULE_6__["Modal"].error({
  ...
  return __jsx(Layout, {
  ...
  }, __jsx("p", null, "Name"), __jsx(antd__WEBPACK_IMPORTED_MODULE_6__["Input"].Search, {
    required: true,
    ...
    className: "col-12 col-lg-4 "
  }, __jsx("p", null, "Store Name"), __jsx(antd__WEBPACK_IMPORTED_MODULE_6__["Input"], {
    ...
    className: "col-12 col-lg-4 "
  }, __jsx("p", null, "Phone Number"), __jsx(antd__WEBPACK_IMPORTED_MODULE_6__["Input"], {
    ...
    className: "col-12 col-lg-4 "
  }, __jsx("p", null, "Address"), __jsx(antd__WEBPACK_IMPORTED_MODULE_6__["Input"], {
    ...
    className: "col-12 col-lg-4 "
  }, __jsx("p", null, "City"), __jsx(antd__WEBPACK_IMPORTED_MODULE_6__["Input"], {
    ...
    className: "col-12 col-lg-4 "
  }, __jsx("p", null, "State"), __jsx(antd__WEBPACK_IMPORTED_MODULE_6__["Input"], {
    ...
    className: "col-12 col-lg-4 "
  }, __jsx("p", null, "Category"), __jsx(antd__WEBPACK_IMPORTED_MODULE_6__["Select"], {
    ...
    className: "col-12 col-lg-4 "
  }, __jsx("p", null, "Sub Category (Optional)"), __jsx(antd__WEBPACK_IMPORTED_MODULE_6__["Select"], {
  ...
  }, "Load Products"))), selectedProducts.length !== 0 && __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("div", {
    ...
    key: el._id
  }, __jsx(_components_Product_js__WEBPACK_IMPORTED_MODULE_10__["default"], {
    data: el,
    isSelectable: true,

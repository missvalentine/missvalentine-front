...
/******/ 			var chunk = require("../../" + ({}[chunkId]||chunkId) + "." + {"0":"1484d4b3a1c58fd8e9d3","1":"9f9e576d8beb99af920b","3":"67b473aabb397619f378","5":"0ee9383cfef15cb417cb","6":"5d195660e5978d6b756c","7":"6fc77f00c1f4916a55bf","9":"b7b7e2243437a51cd575","11":"bad78ca0d6325b40ed88","13":"4eeb7562709d11353e66","14":"6ad7600e29b51b43ad8b","16":"09bb3161e8cb550076cb","20":"cab62ceba200f84c6fda","58":"8d248501ad53fb25530a","66":"e7906676c2159017e236","67":"9c47eda2633b62dba027","68":"f6151c8ee3074693b135","69":"849753c976bc6e985650","81":"b0b05e65253b24eb4957","82":"6fa26618ada0837073e0","85":"75e631d230f4f8c54e63","86":"f97bb9d82c63d9c61103","88":"1c8b79899ab31f96f7b8","89":"3df4c6031215e3fe82b0","93":"b299f3715d54a64d8127","95":"da6f609584c1ca5ef294","96":"b7940a28108d94d981e2","97":"34e45430bff996d84569","98":"d649c782849fa2716241","104":"4e0311d6f119f9637453"}[chunkId] + ".js");
...
module.exports = __webpack_require__("n1n4");
...
/* harmony import */ var _services_apis_apiList__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("Wol/");
/* harmony import */ var _services_helpers_product__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("OWVN");
...
/* harmony import */ var _redux_actions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("x91w");
...
const Layout = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 9).then(__webpack_require__.bind(null, "Vw5z")), {
  ssr: false,
  loadableGenerated: {
...
const ProductCard = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 11).then(__webpack_require__.bind(null, "B7+D")), {
  ssr: false,
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("B7+D")],
    modules: ["../../components/ProductCard"]
  }
});


const SearchBox = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 85).then(__webpack_require__.bind(null, "htNk")), {
  ssr: false,
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("htNk")],
...
const Search = (_ref) => {
  ...
  const {
    0: searchValue,
    1: setSearchValue
  } = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(Search);
  const {
    0: isFilter,
    1: setIsFilter
  ...
  const productsRow = productList.map(el => {
    console.log({
      price: Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_5__[/* getBasicPrice */ "c"])(el),
      el
    });
    return _objectSpread(_objectSpread({}, el), {}, {
      image: el.productImage ? _constants_projectSettings__WEBPACK_IMPORTED_MODULE_6__[/* default */ "d"].serverUrl + el.productImage : "//via.placeholder.com/300x500",
      title: Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_5__[/* getProductTitle */ "i"])(el),
      subTitle: Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_5__[/* getProductShortDesc */ "h"])(el),
      price: Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_5__[/* getBasicPrice */ "c"])(el)
    });
  });
  ...
  const {
    0: products,
    1: setProducts
  } = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])([...productsRow]);
  ...
  }, html_react_parser__WEBPACK_IMPORTED_MODULE_9___default()(`${applySearch(products).length} PRODUCT RESULT FOR <span class="search-text">"${searchValue}"</span>`))))), __jsx("div", {
...
const FilterItem = ({
  ...
  className: classnames__WEBPACK_IMPORTED_MODULE_3___default()("c-shop-page__filter-item", {
...
Search.getInitialProps = async ({
  ...
  const res = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_7___default()(_services_apis_apiList__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].getAllProducts);
  const productList = await res.json();
  const visibleProducts = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_5__[/* getVisibleProducts */ "j"])(productList.products);
  const Searchdata = await Object(_redux_actions__WEBPACK_IMPORTED_MODULE_8__["shopData"])();
  const comboRes = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_7___default()(_services_apis_apiList__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].getAllCombos);
  const comboList = await comboRes.json();
  const visibleCombo = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_5__[/* getVisibleProducts */ "j"])(comboList.combos);
  return {
    Search: query.key,
    productList: visibleProducts.map(el => Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_5__[/* addSlugToProduct */ "a"])(el)),
    combos: visibleCombo.map(el => Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_5__[/* addSlugToProduct */ "a"])(el)),
    shopdata: Searchdata.shop
  };
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(null)(Search));

...
/******/ 			var chunk = require("../../" + ({}[chunkId]||chunkId) + "." + {"0":"1484d4b3a1c58fd8e9d3","1":"9f9e576d8beb99af920b","2":"88c5f2b18456f25e406c","5":"0ee9383cfef15cb417cb","6":"5d195660e5978d6b756c","7":"6fc77f00c1f4916a55bf","12":"4dfdab35aff5f4eb6323","13":"4eeb7562709d11353e66","14":"6ad7600e29b51b43ad8b","15":"05d8f92901b69902ec72","16":"09bb3161e8cb550076cb","17":"b2417b5ec287a3915ffd","19":"a19c890c22e2f014ff5f","20":"cab62ceba200f84c6fda","21":"8d96a0b108d3c1efe9af","57":"5b98c6fba9d93bb7eb18","58":"8d248501ad53fb25530a","61":"ce09f74627d1b52f5480","66":"e7906676c2159017e236","67":"9c47eda2633b62dba027","68":"f6151c8ee3074693b135","69":"849753c976bc6e985650","72":"84614f58cd88a236262a","73":"fdc5ddfc8bd91423ff52","81":"b0b05e65253b24eb4957","82":"6fa26618ada0837073e0","86":"f97bb9d82c63d9c61103","88":"1c8b79899ab31f96f7b8","89":"3df4c6031215e3fe82b0","90":"ac72bf674906b647dd1e","93":"b299f3715d54a64d8127","94":"ffc7e30aeb01546f35f3","95":"da6f609584c1ca5ef294","96":"b7940a28108d94d981e2","97":"34e45430bff996d84569","98":"d649c782849fa2716241","103":"d008ed2c7672f947a96e","104":"4e0311d6f119f9637453"}[chunkId] + ".js");
...
module.exports = __webpack_require__("NGVa");
...
/* harmony import */ var _services_helpers_product__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("OWVN");
...
/* harmony import */ var _constants_projectSettings__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("xSWb");
/* harmony import */ var _services_apis_apiList__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("Wol/");
...
const Layout = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 57).then(__webpack_require__.bind(null, "Vw5z")), {
  ssr: false,
  loadableGenerated: {
...
const ProductInfo = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 61).then(__webpack_require__.bind(null, "2uFY")), {
  ssr: false,
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("2uFY")],
    modules: ["../../components/ProductInfo"]
  }
});
const HImgSection = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 15).then(__webpack_require__.bind(null, "Q9jL")), {
  ssr: false,
  loadableGenerated: {
...
const ProductDetailsTab = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 19).then(__webpack_require__.bind(null, "+TUq")), {
  ssr: false,
  loadableGenerated: {
...
const ProductSlider = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 17).then(__webpack_require__.bind(null, "0GkY")), {
  ssr: false,
  loadableGenerated: {
...
const Product = (_ref) => {
  ...
  const productAttr = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_2__[/* getProductAttributes */ "d"])(product, allProducts);
  const image = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_2__[/* getProductImage */ "f"])(product, "sectionB"); //|| "/images/cbd-oil.png"

  const productImage = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_2__[/* getProductImage */ "f"])(product) ? _constants_projectSettings__WEBPACK_IMPORTED_MODULE_6__[/* default */ "d"].serverUrl + Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_2__[/* getProductImage */ "f"])(product) : "/images/cbd-oil.png";

  if (props.err) {
    return __jsx(next_error__WEBPACK_IMPORTED_MODULE_8___default.a, props.err);
  }
  ...
  return __jsx(Layout, {
    ...
    version: ["full"],
    image: _constants_projectSettings__WEBPACK_IMPORTED_MODULE_6__[/* default */ "d"].filePath + image
  }, __jsx("div", null, __jsx(Heading, {
    style: {
      fontSize: "30px",
      fontFamily: "futuraBT-book"
    }
  }, Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_2__[/* getProductDescription */ "e"])(product))), __jsx("div", {
...
Product.getInitialProps = async ({
  ...
  // } = projectSettings
  let product = null;
  const res = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()(_services_apis_apiList__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"].getProductByName + query.pid); // const res           = await fetch(apiList.getProductById+query.pid)

  const productObj = await res.json();

  if (!productObj.product_details) {
    const res = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()(_services_apis_apiList__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"].getProductById + query.pid);
    const productObj = await res.json();
    product = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_2__[/* getVisibleProducts */ "j"])([productObj.product_details]);
  } else {
    product = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_2__[/* getVisibleProducts */ "j"])([productObj.product_details]);
  }

  const reviewRes = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()(_services_apis_apiList__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"].getReviews + productObj.product_details._id);
  const reviews = await reviewRes.json();
  const allRes = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()(_services_apis_apiList__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"].getAllProducts);
  const allProductObj = await allRes.json();
  const allProducts = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_2__[/* getVisibleProducts */ "j"])(allProductObj.products).filter(el => el._id !== query.pid);

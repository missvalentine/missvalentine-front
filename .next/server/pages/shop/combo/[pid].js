...
module.exports = __webpack_require__("ThhD");
...
const Layout = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 56).then(__webpack_require__.bind(null, "Vw5z")), {
  ssr: false,
  loadableGenerated: {
...
const ProductInfo = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 60).then(__webpack_require__.bind(null, "2uFY")), {
  ssr: false,
  loadableGenerated: {
...
const ProductDetailsTab = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 64).then(__webpack_require__.bind(null, "+TUq")), {
  ssr: false,
  loadableGenerated: {
...
const Product = (_ref) => {
  ...
  const productAttr = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_2__[/* getProductAttributes */ "d"])(product);
  ...
  }, __jsx("div", null, __jsx(Heading, null, Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_2__[/* getProductDescription */ "e"])(product))), __jsx("div", {
...
Product.getInitialProps = async ({
  ...
  const {
    baseUrl
  } = _constants_projectSettings__WEBPACK_IMPORTED_MODULE_6__[/* default */ "d"];
  const res = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()(baseUrl + "/products/api/getbyid/" + query.pid);
  const productObj = await res.json();
  const product = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_2__[/* getVisibleProducts */ "j"])([productObj.product_details]);
  return {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["connect"])(state => state)(Product));

...
module.exports = __webpack_require__("5DHk");
...
// CONCATENATED MODULE: ./services/apis/blog.js


console.log(apiList["a" /* default */].getCategoryByName);
const getBlogs = (pageNo, tag) => external_axios_default.a.post(apiList["a" /* default */].getBlogs, {
  pageNo,
  tag
});
const getCategory = name => {
  console.log(apiList["a" /* default */].getCategoryByName, name);
  return external_axios_default.a.get(apiList["a" /* default */].getCategoryByName + name);
};
const getBanner = name => {
  console.log(apiList["a" /* default */].getBannerByName, name);
  return external_axios_default.a.get(apiList["a" /* default */].getBannerByName + name);
};
// EXTERNAL MODULE: ./constants/projectSettings.js
var projectSettings = __webpack_require__("xSWb");
...
// CONCATENATED MODULE: ./pages/shop/index.js
...
const Layout = dynamic_default()(() => __webpack_require__.e(/* import() */ 9).then(__webpack_require__.bind(null, "Vw5z")), {
  ssr: false,
  loadableGenerated: {
...
const ProductCard = dynamic_default()(() => __webpack_require__.e(/* import() */ 11).then(__webpack_require__.bind(null, "B7+D")), {
  ssr: false,
  loadableGenerated: {
...
const antIcon = __jsx(icons_["LoadingOutlined"], {
  style: {
    fontSize: 50,
    color: "black"
  },
...
const Banner = dynamic_default()(() => __webpack_require__.e(/* import() */ 10).then(__webpack_require__.bind(null, "7fZ1")), {
  ssr: false,
  loadableGenerated: {
...
const Shop = (_ref) => {
  ...
  const productsRow = productList.map(el => {
    console.log({
      price: Object(product["c" /* getBasicPrice */])(el),
      el
    });
    return _objectSpread(_objectSpread({}, el), {}, {
      image: el.productImage ? projectSettings["d" /* default */].serverUrl + el.productImage : "//via.placeholder.com/300x500",
      title: Object(product["i" /* getProductTitle */])(el),
      subTitle: Object(product["h" /* getProductShortDesc */])(el),
      price: Object(product["c" /* getBasicPrice */])(el)
    });
  });
  ...
  const {
    0: products,
    1: setProducts
  } = Object(external_react_["useState"])([...productsRow]);
  ...
  return __jsx(Layout, {
    ...
    versions: ["shop-all"]
  }, external_html_react_parser_default()(shopdata.title))))), __jsx("div", {
    ...
    mg: el.totalcbdmg
  }))))), combos && combos.length > 1 && __jsx(external_react_default.a.Fragment, null) // <div className="c-category-page__combos-wrapper">
  ...
  , __jsx("div", {
    ...
    onClick: () => toTop()
  }, "BACK TO TOP", " ", __jsx(external_react_lazy_load_image_component_["LazyLoadImage"], {
    className: "top",
    style: {
      height: "20px",
      marginBottom: "5px"
...
const FilterItem = ({
  ...
  className: external_classnames_default()("c-shop-page__filter-item", {
...
Shop.getInitialProps = async ({
  ...
  const res = await external_isomorphic_unfetch_default()(apiList["a" /* default */].getAllProducts);
  const productList = await res.json();
  const visibleProducts = Object(product["j" /* getVisibleProducts */])(productList.products);
  const Shopdata = await Object(actions["shopData"])();
  const comboRes = await external_isomorphic_unfetch_default()(apiList["a" /* default */].getAllCombos);
  const comboList = await comboRes.json();
  const visibleCombo = Object(product["j" /* getVisibleProducts */])(comboList.combos);
  return {
    category: query.cid,
    productList: visibleProducts.map(el => Object(product["a" /* addSlugToProduct */])(el)),
    combos: visibleCombo.map(el => Object(product["a" /* addSlugToProduct */])(el)),
    shopdata: Shopdata.shop
  };
};

/* harmony default export */ var shop = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(null)(Shop));

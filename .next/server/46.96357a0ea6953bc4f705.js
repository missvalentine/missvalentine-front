...
const Product = next_dynamic__WEBPACK_IMPORTED_MODULE_3___default()(() => __webpack_require__.e(/* import() */ 44).then(__webpack_require__.bind(null, "nQYz")), {
  loadableGenerated: {
...
const ProductSlider = ({
  ...
  return __jsx("div", {
    ...
    const title = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_4__[/* getProductTitle */ "e"])(el);
    const image = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_4__[/* getProductImage */ "c"])(el);
    const subTitle = Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_4__[/* getProductShortDesc */ "d"])(el);
    return __jsx("div", {
      key: i,

...
/* harmony import */ var _services_extra_productHelpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("TcCU");
...
class ChatProductList extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
    ...
    this.state = {
      products: Object(_services_extra_productHelpers__WEBPACK_IMPORTED_MODULE_3__[/* getProductsByCategory */ "d"])(props.products, props.steps.categoryList.value),
      isLoading: true,
      selected: null
    };
  }
  ...
  componentDidMount() {
    Object(_services_api__WEBPACK_IMPORTED_MODULE_5__[/* getAllProducts */ "o"])().then(res => {
      const products = Object(_services_extra_productHelpers__WEBPACK_IMPORTED_MODULE_3__[/* getProductsByCategory */ "d"])(res.data.products || [], this.props.steps.categoryList.value);
      this.setState({
        products: Object(_services_helpers_product__WEBPACK_IMPORTED_MODULE_4__[/* getVisibleProducts */ "j"])(products),
        isLoading: false
      });
    });
  }
  ...
  render() {
    ...
    return __jsx("div", null, isLoading && "...", !isLoading && products.map((el, index) => {
      ...
      return __jsx("p", {
        ...
        className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("chat-custom-option w-100", {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(mapStateToProps)(ChatProductList));

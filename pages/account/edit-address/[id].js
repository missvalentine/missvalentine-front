...
const MyAccountSidebar = dynamic(() => import("../../../components/MyAccountSidebar"), {
  ssr: false,
});
...
class EditAddress extends Component {
  ...
  fillAddress = () => {
    if (this.props.address.address) {
      ...
      if (currentAddress) {
        console.log(currentAddress.zip);
        this.setState(
          {
            isFound: true,
            ...
            shipping_address_name_01: currentAddress.addressStr || "",
            ...
            addressData: {
              ...
              address: currentAddress.addressStr,
    ...
    setTimeout(() => {
      ...
      if (!flag) {
        ...
        const newAddress = {
          ...
          zip,
          phone,
          addressStr: `${city}, ${state}, ${country}, ${zip}`.trim(),
          country,
          state,
          city,
          addressType,
  ...
  render() {
    ...
    console.log(this.state.shipping_zip_code);
                  ...
                  <form onSubmit={this.submitRegistration}>
                    <Card className="panel-section my-order__panel">
                      <div className="my-order__detail">
                        ...
                        <div className="billing-address-text py-4 card-title flag-none  ">
                          <AddressForm
                            name={shipping_first_name}
                    ...
                    /> */}
                      ...
                      <div className="row" style={{ justifyContent: "center" }}>
                        <button
                          className="btn or-btn  btn-icon c-btn c-btn--dark  mt-5"
                          // className="btn or-btn btn-outline-shopping btn-icon c-btn c-btn--outline my-order__shopping mt-5"
                          type="submit"
                        >
                          Submit
                        </button>
...
export default connect(mapStateToProps, { editAddress, getAddress })(

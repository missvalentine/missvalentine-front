...
class Registration extends Component {
  ...
  fieldVaidation(field, type, match) {
    ...
    if (typeArr.includes('profession')) {
      if (isAlpha(this.state[field])) {
        this.setState({
          [field + '_err']: false,
          [field + '_errMsg']: '',
        ...
        >
          <div className="container">
            {welcomeMsg ? (
              <div className="row m-10">
                ...
                <div className="col-md-6 text-center offset-md-3">
                  ...
                  <p>
                    ...
                    <br />
                    <a
                      href="mailto:ambassador@cbdbene.com"
                      style={{ color: 'black' }}
                    >
              ...
              <div className="row justify-content-center Regular w-sm-100">
                <div className="w-100 ">
                ...
                <div className="p-md-5 p-3 my-5 register shadowBoxBackground ambassador-reg-form">
                  <h1 className="c-ambassador-login__heading c-ambassador-login__heading--large">
